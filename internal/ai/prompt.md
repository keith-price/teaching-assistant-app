...
TL;DR Summary
GOAL: Create a level-specific ESL student worksheet and teacher's answer key.
...
3. Gap-Fills: Use exactly eight underscores ("________") for all gaps to prevent formatting errors. Exception: A1/A2 may use a first-letter scaffold (e.g., "b________").
...
* *IF LISTENING LESSON:* Add a "First Watch (Gist)" instruction reminding students to listen only for the main idea without taking notes.
...
* *IF READING:* Provide the level-adapted text with clear headings. Bold 3-4 key vocabulary items.
* *IF LISTENING:* Provide a specific note-taking or sequencing task for the second watch.
...
Do not output anything other than the Markdown content as directed in the prompt above.